	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v.get() ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestNotDirectory %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestMakeDirectory(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v.get() ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestMakeDirectory %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestChownR(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v.get() ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestChownR %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
