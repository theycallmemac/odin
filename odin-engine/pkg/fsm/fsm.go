...
// Open is called on a store type and is used to boostrap the cluster
...
// Join is called on a store type and is used to join a node to the cluster
...
// Leave is called on a store type and is used to remove a node from the cluster
...
// NewStore is used to initialize a Store tstruct
// parameters: nil
...
// PeersList is used to get the list of peers from a raft config
