...
// exists is used to check if a directory exists
...
// ProcessError is used to switch between the different error types
...
// ReviewError is used to print out an error if it exists
