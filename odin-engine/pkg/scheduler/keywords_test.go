	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("getValidKeywords()"), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestGetValidKeywords %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestGetDowMap(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("getDowMap()"), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestTestGetDowMap %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestGetDomMap(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("getDomMap()"), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestTestGetDomMap %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestGetMonMap(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("getMonMap()"), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestTestGetMonMap %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
