...
// stripChars is used to strip characters from string
...
// splitOnKeyword is used to split a string on a keyword
...
// trimEdges is used to trim special characters from either end of a string
