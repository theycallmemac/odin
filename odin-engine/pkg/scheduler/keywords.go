...
// getDomMap is used to return a map of days of the month to numeric values
// parameters:  nil
...
// getMonMap is used to return a map of months of the year to numeric values
// parameters:  nil
