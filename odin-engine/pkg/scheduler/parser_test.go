	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("isTimeValid(%s) ", testCase.A), func(t *testing.T) {
			...
			if len(actual) != testCase.Expected {
				t.Errorf("TestIsTimeValid %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("isScheduleValid(%s) ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestIsScheduleValid %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestGetCron(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("getCron(%s) ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestGetCron %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestGetCronMonth(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("getCronMonth(%s) ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestGetCronMonth %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestExecute(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("Execute(%s) ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestExecute %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
