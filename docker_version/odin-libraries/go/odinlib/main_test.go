...
func TestSetup(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("Setup(%s) ", testCase.A), func(t *testing.T) {
			...
			if odin.ID != testCase.Expected {
				t.Errorf("TestSetup %d failed - expected: '%v' got: '%v'", i+1, testCase.Expected, odin.ID)
			}
		})
	}
}
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("Condition(%s, %s) ", testCase.A, testCase.B), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestCondition %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
func TestWatch(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("Watch(%s, %s) ", testCase.A, testCase.B), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestWatch %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestResult(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("Result(%s, %s) ", testCase.A, testCase.B), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestResult %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
