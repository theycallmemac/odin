	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v ", testCase.Name), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestDeployConfig %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestDeployReadJobFile(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v ", testCase.Name), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestDeployReadJobFile %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestDeployUnmarshalYaml(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v.parse() ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestDeployUnmarshalYaml %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestDeployEnsureDirectory(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v.parse() ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestDeployEnsureDirectory %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
...
func TestDeployGetScheduleString(t *testing.T) {
	...
	for i, testCase := range cases {
		t.Run(fmt.Sprintf("%v.parse() ", testCase.A), func(t *testing.T) {
			...
			if actual != testCase.Expected {
				t.Errorf("TestDeployGetScheduleString %d failed - expected: '%v' got: '%v'", i+1, actual, testCase.Expected)
			}
		})
	}
}
